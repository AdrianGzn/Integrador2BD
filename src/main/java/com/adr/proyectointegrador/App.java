package com.adr.proyectointegrador;

import com.adr.proyectointegrador.models.Aplication;
...
public class App extends Application {
    private static Aplication aplication = new Aplication();
    private static Stage stageView;
    private static Stage stageRoot;

    public static Aplication getAplication() {
        return aplication;
    }
